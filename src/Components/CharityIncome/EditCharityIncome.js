...
let printSave = false;
class EditCharityIncome extends Component {
  constructor(props) {
    super(props);
    this.state = {
      type: "cash",
          ...
          <Form className="form-income" onSubmit={this.handleSubmit}>
            <Row gutter={[16, 16]}>
              <Col span={8}>
                ...
                <Form.Item label="pahaoMca">
                  {getFieldDecorator("slip_no", {
                    rules: [{ required: true }],
                    initialValue: data.slip_no,
                  })(
                    <InputNumber
              ...
              <Col span={8}>
                {/* ------------------------------Income Type--------------------------------- */}
                <Form.Item className="" label="Aavak naao pakar" hasFeedback>
                  {getFieldDecorator("type", {
                    rules: [{ required: true }],
                    initialValue: convertNumberToType(data.type, "income"),
                  })(
                    <Select
                    ...
                    >
                      ...
                      <Option value="Kaatar naI Aavak">Kaatar naI Aavak</Option>
            ...
            <Row gutter={[16, 16]}>
              <Col span={16}>
                {/* ------------------------------Doner Name-------------------------------- */}
                <Form.Item className="input-name-gujarati" label="dataaEaI:">
              ...
              <Col span={8}>
                ...
                <Form.Item label="dana svaIkar">
                  {getFieldDecorator("moneyobject", {
                    rules: [{ required: true }],
                    initialValue: data.money ? data.money.type : "",
                  })(
                ...
                {this.state.type === "cheque" ? (
                  <Form.Item className="cheque-no" label="caok naM.:">
                    {getFieldDecorator("chequeno", {
                      rules: [{ required: true }],
                      initialValue: data.money ? data.money.cheque_no : "",
                    })(
                      <Input
                        type="number"
                        className=""
...
const EditCharityIncomes = Form.create({ name: "Income" })(EditCharityIncome);
